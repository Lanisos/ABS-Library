...
public class ItemCreaErrorCheck : EditorWindow
{
    ...
    public static void ShowWindow(int given_code, string name) {
        code = given_code;
        chosen_name = name;
        EditorWindow.GetWindow(typeof(ItemCreaErrorCheck));
    }
    ...
    void OnGUI() {
        ...
        switch (code) {
                case 0:
                    ...
                    GUILayout.Label("Item " + chosen_name + " successfully created!",style);
                    break;
                case 1:
                ...
                case 3:
                    style.normal.textColor = Color.red;
                    GUILayout.Label("ERROR: Item's name is already registered!",style);
                    break;
        }
